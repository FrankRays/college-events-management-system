...
public class PlacementInformationDelete extends Action {
	/*
	 * Generated Methods
	 */
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try {
			for (int i = 0; i < ch.length; i++) {
				...
				flag = new PlacementInformationServiceImpl()
						.deleteStudyDetails(Integer.parseInt(ch[i]));
			}
			if (flag) {
				...
				request.setAttribute("message",
						"Study Record Not Deleted SuccessFully");
