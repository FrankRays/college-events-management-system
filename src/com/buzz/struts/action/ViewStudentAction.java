...
public class ViewStudentAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		Vector<StudentDetailsBean> vStudentDetailsBeans = null;
		String target = null;
		try {
			vStudentDetailsBeans = new StudentDetailsServiceImpl().viewOrganisers();
			if (!vStudentDetailsBeans.isEmpty()) {
				request.setAttribute("vStudentDetailsBeans",
